    ...
    <div class="row">
      <div class="col-md-6 ">
        <a href="blog/{{$post -> slug}}">
          <img src="/images/{{$post -> image_path}}" alt="" class="img-fluid rounded" style="">
        </a>
      </div>
      <div class="col-md-6 mt-2 " style="position: relative; left:15px;">
        ...
        on  <span class=" " style="font-style: italic ;color: orange;">{{date('d-m-Y', strtotime($post-> updated_at    ))}}</span>
        <div class="exemple">
          <p class=" mt-4 mb-4  descri" style="color: #6B7280;width: 95%">{{$post -> description}}</p>
        </div>
        <a href="blog/{{$post -> slug}}" class="btn  mt-3" style="background-color: #374150;color:white">READ MORE</a>
      </div>
    </div>
  </div>
